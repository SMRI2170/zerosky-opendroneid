...
- `rapidsnark_app/lib/main.dart`
  - デモアプリ本体 (Flutter アプリ、内部で YOLO モデルによるドローン検知を実行)
- `uav/remote_id.py`
...
このリポジトリで確認していた主なバージョンは [zk-distance/README.md](./zk-distance/README.md) にあります。
